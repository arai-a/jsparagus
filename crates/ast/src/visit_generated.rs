...
pub trait Pass<'alloc> {
    ...
    fn visit_enum_program_variant_module(&mut self, ast: &'alloc Module<'alloc>) {
        self.enter_enum_program_variant_module(ast);
        self.visit_module(ast);
        self.leave_enum_program_variant_module(ast);
    }

    fn enter_enum_program_variant_module(&mut self, ast: &'alloc Module<'alloc>) {}

    fn leave_enum_program_variant_module(&mut self, ast: &'alloc Module<'alloc>) {}

    fn visit_enum_program_variant_script(&mut self, ast: &'alloc Script<'alloc>) {
        self.enter_enum_program_variant_script(ast);
        self.visit_script(ast);
        self.leave_enum_program_variant_script(ast);
    }

    fn enter_enum_program_variant_script(&mut self, ast: &'alloc Script<'alloc>) {}

    fn leave_enum_program_variant_script(&mut self, ast: &'alloc Script<'alloc>) {}
    ...
    fn visit_statement(&mut self, ast: &'alloc Statement<'alloc>) {
        ...
        match ast {
            ...
            Statement::LabelledStatement { label, body, .. } => {
                self.visit_enum_statement_variant_labelled_statement(label, body)
            }
    ...
    fn visit_enum_statement_variant_block_statement(&mut self, block: &'alloc Block<'alloc>) {
    ...
    fn leave_enum_statement_variant_block_statement(&mut self, block: &'alloc Block<'alloc>) {}

    fn visit_enum_statement_variant_break_statement(&mut self, label: &'alloc Option<Label>) {
    ...
    fn enter_enum_statement_variant_break_statement(&mut self, label: &'alloc Option<Label>) {}

    fn leave_enum_statement_variant_break_statement(&mut self, label: &'alloc Option<Label>) {}

    fn visit_enum_statement_variant_continue_statement(&mut self, label: &'alloc Option<Label>) {
    ...
    fn enter_enum_statement_variant_continue_statement(&mut self, label: &'alloc Option<Label>) {}

    fn leave_enum_statement_variant_continue_statement(&mut self, label: &'alloc Option<Label>) {}
    ...
    fn visit_enum_statement_variant_if_statement(&mut self, ast: &'alloc IfStatement<'alloc>) {
    ...
    fn enter_enum_statement_variant_if_statement(&mut self, ast: &'alloc IfStatement<'alloc>) {}

    fn leave_enum_statement_variant_if_statement(&mut self, ast: &'alloc IfStatement<'alloc>) {}
    ...
    fn visit_enum_statement_variant_labelled_statement(
        ...
        self.enter_enum_statement_variant_labelled_statement(label, body);
        self.visit_label(label);
        self.visit_statement(body);
        self.leave_enum_statement_variant_labelled_statement(label, body);
    }
    ...
    fn visit_enum_statement_variant_function_declaration(&mut self, ast: &'alloc Function<'alloc>) {
    ...
    fn visit_enum_expression_variant_literal_boolean_expression(&mut self, value: &'alloc bool) {
    ...
    fn enter_enum_expression_variant_literal_boolean_expression(&mut self, value: &'alloc bool) {}

    fn leave_enum_expression_variant_literal_boolean_expression(&mut self, value: &'alloc bool) {}
    ...
    fn visit_enum_expression_variant_function_expression(&mut self, ast: &'alloc Function<'alloc>) {
    ...
    fn visit_enum_expression_variant_optional_chain(&mut self, ast: &'alloc OptionalChain<'alloc>) {
    ...
    fn enter_enum_expression_variant_optional_chain(&mut self, ast: &'alloc OptionalChain<'alloc>) {
    }

    fn leave_enum_expression_variant_optional_chain(&mut self, ast: &'alloc OptionalChain<'alloc>) {
    }
    ...
    fn visit_optional_chain(&mut self, ast: &'alloc OptionalChain<'alloc>) {
        ...
        match ast {
            ...
            OptionalChain::PrivateFieldExpressionTail { field, .. } => {
                self.visit_enum_optional_chain_variant_private_field_expression_tail(field)
            }
    ...
    fn visit_enum_optional_chain_variant_private_field_expression_tail(
        ...
        self.enter_enum_optional_chain_variant_private_field_expression_tail(field);
        self.visit_private_identifier(field);
        self.leave_enum_optional_chain_variant_private_field_expression_tail(field);
    }
    ...
    fn visit_enum_method_definition_variant_method(&mut self, ast: &'alloc Method<'alloc>) {
    ...
    fn visit_enum_method_definition_variant_getter(&mut self, ast: &'alloc Getter<'alloc>) {
    ...
    fn enter_enum_method_definition_variant_getter(&mut self, ast: &'alloc Getter<'alloc>) {}

    fn leave_enum_method_definition_variant_getter(&mut self, ast: &'alloc Getter<'alloc>) {}

    fn visit_enum_method_definition_variant_setter(&mut self, ast: &'alloc Setter<'alloc>) {
    ...
    fn enter_enum_method_definition_variant_setter(&mut self, ast: &'alloc Setter<'alloc>) {}

    fn leave_enum_method_definition_variant_setter(&mut self, ast: &'alloc Setter<'alloc>) {}
    ...
    fn visit_enum_import_declaration_variant_import(&mut self, ast: &'alloc Import<'alloc>) {
    ...
    fn enter_enum_import_declaration_variant_import(&mut self, ast: &'alloc Import<'alloc>) {}

    fn leave_enum_import_declaration_variant_import(&mut self, ast: &'alloc Import<'alloc>) {}
    ...
    fn visit_enum_export_declaration_variant_export(&mut self, ast: &'alloc Export<'alloc>) {
    ...
    fn enter_enum_export_declaration_variant_export(&mut self, ast: &'alloc Export<'alloc>) {}
    ...
    fn visit_enum_binding_variant_binding_pattern(&mut self, ast: &'alloc BindingPattern<'alloc>) {
    ...
    fn enter_enum_binding_variant_binding_pattern(&mut self, ast: &'alloc BindingPattern<'alloc>) {}

    fn leave_enum_binding_variant_binding_pattern(&mut self, ast: &'alloc BindingPattern<'alloc>) {}

    fn visit_enum_binding_variant_binding_identifier(&mut self, ast: &'alloc BindingIdentifier) {
        self.enter_enum_binding_variant_binding_identifier(ast);
        self.visit_binding_identifier(ast);
        self.leave_enum_binding_variant_binding_identifier(ast);
    }

    fn enter_enum_binding_variant_binding_identifier(&mut self, ast: &'alloc BindingIdentifier) {}

    fn leave_enum_binding_variant_binding_identifier(&mut self, ast: &'alloc BindingIdentifier) {}
    ...
    fn visit_enum_parameter_variant_binding(&mut self, ast: &'alloc Binding<'alloc>) {
        self.enter_enum_parameter_variant_binding(ast);
        self.visit_binding(ast);
        self.leave_enum_parameter_variant_binding(ast);
    }

    fn enter_enum_parameter_variant_binding(&mut self, ast: &'alloc Binding<'alloc>) {}

    fn leave_enum_parameter_variant_binding(&mut self, ast: &'alloc Binding<'alloc>) {}
    ...
    fn visit_member_assignment_target(&mut self, ast: &'alloc MemberAssignmentTarget<'alloc>) {
        ...
        match ast {
            ...
            MemberAssignmentTarget::PrivateFieldAssignmentTarget(ast) => self
                .visit_enum_member_assignment_target_variant_private_field_assignment_target(ast),
    ...
    fn visit_private_field_assignment_target(
        &mut self,
        ast: &'alloc PrivateFieldAssignmentTarget<'alloc>,
    ) {
    ...
    fn enter_private_field_assignment_target(
        &mut self,
        ast: &'alloc PrivateFieldAssignmentTarget<'alloc>,
    ) {
    }

    fn leave_private_field_assignment_target(
        &mut self,
        ast: &'alloc PrivateFieldAssignmentTarget<'alloc>,
    ) {
    }
    ...
    fn leave_binding_property_identifier(
        &mut self,
        ast: &'alloc BindingPropertyIdentifier<'alloc>,
    ) {
    }
    ...
    fn visit_assignment_target_maybe_default(
        &mut self,
        ast: &'alloc AssignmentTargetMaybeDefault<'alloc>,
    ) {
    ...
    fn visit_enum_export_variant_function_declaration(&mut self, ast: &'alloc Function<'alloc>) {
        self.enter_enum_export_variant_function_declaration(ast);
        self.visit_function(ast);
        self.leave_enum_export_variant_function_declaration(ast);
    }

    fn enter_enum_export_variant_function_declaration(&mut self, ast: &'alloc Function<'alloc>) {}

    fn leave_enum_export_variant_function_declaration(&mut self, ast: &'alloc Function<'alloc>) {}
    ...
    fn visit_template_expression_element(
        &mut self,
        ast: &'alloc TemplateExpressionElement<'alloc>,
    ) {
    ...
    fn enter_template_expression_element(
        &mut self,
        ast: &'alloc TemplateExpressionElement<'alloc>,
    ) {
    }

    fn leave_template_expression_element(
        &mut self,
        ast: &'alloc TemplateExpressionElement<'alloc>,
    ) {
    }
    ...
    fn visit_variable_declaration_or_assignment_target(
        &mut self,
        ast: &'alloc VariableDeclarationOrAssignmentTarget<'alloc>,
    ) {
    ...
    fn visit_variable_declaration_or_expression(
        &mut self,
        ast: &'alloc VariableDeclarationOrExpression<'alloc>,
    ) {
