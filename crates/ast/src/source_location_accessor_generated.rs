...
impl<'alloc> SourceLocationAccessor for CompoundAssignmentOperator {
    ...
    fn get_loc(&self) -> SourceLocation {
        match self {
            CompoundAssignmentOperator::LogicalOr { loc } => *loc,
            CompoundAssignmentOperator::LogicalAnd { loc } => *loc,
            CompoundAssignmentOperator::Coalesce { loc } => *loc,
...
impl<'alloc> SourceLocationAccessor for Expression<'alloc> {
    ...
    fn get_loc(&self) -> SourceLocation {
        match self {
            ...
            Expression::OptionalExpression { loc, .. } => *loc,
...
impl<'alloc> SourceLocationAccessor for MemberAssignmentTarget<'alloc> {
    fn set_loc(&mut self, start: SourceLocation, end: SourceLocation) {
        match self {
            ...
            MemberAssignmentTarget::PrivateFieldAssignmentTarget(content) => {
                content.set_loc(start, end)
            }
...
impl<'alloc> SourceLocationAccessor for OptionalChain<'alloc> {
    ...
    fn get_loc(&self) -> SourceLocation {
        match self {
            OptionalChain::ComputedMemberExpressionTail { loc, .. } => *loc,
            OptionalChain::StaticMemberExpressionTail { loc, .. } => *loc,
            OptionalChain::PrivateFieldExpressionTail { loc, .. } => *loc,
            OptionalChain::CallExpressionTail { loc, .. } => *loc,
...
impl<'alloc> SourceLocationAccessor for Statement<'alloc> {
    ...
    fn get_loc(&self) -> SourceLocation {
        match self {
            ...
            Statement::LabelledStatement { loc, .. } => *loc,
