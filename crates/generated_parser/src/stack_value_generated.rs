...
impl<'alloc> StackValueItem<'alloc> for ArrayAssignmentTarget<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ArrayAssignmentTarget, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ArrayExpressionElement<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ArrayExpressionElement, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ArrowExpressionBody<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ArrowExpressionBody, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for AssignmentTarget<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected AssignmentTarget, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for AssignmentTargetPattern<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected AssignmentTargetPattern, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for AssignmentTargetProperty<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected AssignmentTargetProperty, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for BindingIdentifier {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected BindingIdentifier, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for BindingPropertyProperty<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected BindingPropertyProperty, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for BindingWithDefault<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected BindingWithDefault, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ClassDeclaration<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ClassDeclaration, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ComputedMemberExpression<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ComputedMemberExpression, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ComputedPropertyName<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ComputedPropertyName, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for CoverParenthesized<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected CoverParenthesized, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ExportDeclaration<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ExportDeclaration, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ExportFromSpecifier {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ExportFromSpecifier, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ExportLocalSpecifier {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ExportLocalSpecifier, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ExpressionOrSuper<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ExpressionOrSuper, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for FormalParameters<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected FormalParameters, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for IdentifierExpression {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected IdentifierExpression, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ImportDeclaration<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ImportDeclaration, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for MemberAssignmentTarget<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected MemberAssignmentTarget, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for MemberExpression<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected MemberExpression, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for MethodDefinition<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected MethodDefinition, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for NamedObjectProperty<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected NamedObjectProperty, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ObjectAssignmentTarget<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ObjectAssignmentTarget, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ObjectExpression<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ObjectExpression, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for PrivateFieldAssignmentTarget<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected PrivateFieldAssignmentTarget, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for ShorthandProperty {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected ShorthandProperty, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for SimpleAssignmentTarget<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected SimpleAssignmentTarget, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for StaticMemberExpression<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected StaticMemberExpression, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for StaticPropertyName {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected StaticPropertyName, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for TemplateExpression<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected TemplateExpression, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for VariableDeclaration<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected VariableDeclaration, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for VariableDeclarationKind {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected VariableDeclarationKind, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for VariableDeclarator<'alloc> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected VariableDeclarator, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for VariableReference {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected VariableReference, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for arena::Vec<'alloc, BindingProperty<'alloc>> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected Vec<BindingProperty>, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for arena::Vec<'alloc, Option<Parameter<'alloc>>> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected Vec<Option<Parameter>>, got {:?}",
                sv
            )),
        }
    }
...
impl<'alloc> StackValueItem<'alloc> for arena::Vec<'alloc, VariableDeclarator<'alloc>> {
    fn to_ast(sv: StackValue<'alloc>) -> AstResult<'alloc, Self> {
        match sv {
            ...
            _ => Err(format!(
                "StackValue expected Vec<VariableDeclarator>, got {:?}",
                sv
            )),
        }
    }
